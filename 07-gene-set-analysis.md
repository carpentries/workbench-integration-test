...
Unit: microseconds
 ...
 fisher 251.919 256.193 281.32486 260.9115 274.0310 1738.491   100
  hyper   1.543   1.738   2.58829   2.7755   3.0805   11.331   100
```
...
``` output
--> Expected input gene ID: 216860,18975,52276,238217,27393,243529
```
